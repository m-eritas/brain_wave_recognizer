...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (rst,
    sys_clk,
    vga_b,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLK, ASSOCIATED_RESET ext_reset_in_0, CLK_DOMAIN design_1_sys_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clk;
  output [3:0]vga_b;
  output [3:0]vga_g;
  output vga_hsync;
  output [3:0]vga_r;
  ...
  wire [17:0]brainwave_recognizer_0_env_out;
  wire brainwave_recognizer_0_flag_out;
  wire [17:0]brainwave_recognizer_0_threshold_out;
  wire clk_in1_0_1;
  ...
  wire test_signal_generator_0_sample_valid;
  ...
  design_1_brainwave_recognizer_0_0 brainwave_recognizer_0
       (.ap_clk(clk_wiz_0_clk_out1),
        ...
        .env_out(brainwave_recognizer_0_env_out),
        .flag_out(brainwave_recognizer_0_flag_out),
        .sample(test_signal_generator_0_sample_out),
        .sample_valid(test_signal_generator_0_sample_valid),
        .threshold_out(brainwave_recognizer_0_threshold_out),
        .threshold_sel(sens_sel_dout));
  ...
  design_1_test_signal_generator_0_0 test_signal_generator_0
       (.clk(clk_wiz_0_clk_out1),
        ...
        .sample_valid(test_signal_generator_0_sample_valid));
  design_1_xlconstant_0_3 threshold_sel
       (.dout(sens_sel_dout));
  design_1_vga_display_0_0 vga_display_0
       (.b(vga_display_0_b),
        .band_sel(band_sel_dout),
        .clk(clk_wiz_0_clk_out1),
        .env_in(brainwave_recognizer_0_env_out),
        .g(vga_display_0_g),
        .hsync(vga_display_0_hsync),
        .r(vga_display_0_r),
        .rst(proc_sys_reset_0_peripheral_reset),
        .sample_in(test_signal_generator_0_sample_out),
        .sample_valid(test_signal_generator_0_sample_valid),
        .threshold_in(brainwave_recognizer_0_threshold_out),
